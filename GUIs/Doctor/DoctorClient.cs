...
{
    private readonly Dictionary<string, Action<DataPacket>> _callbacks = new();

    private List<string> _connected;

    private readonly Log _log = new(typeof(DoctorClient));
    ...
    ///     This is the object that is sent from the server to the client. It contains the data
