namespace RemoteHealthcare.Common
{
    public class OperationCodes
    {
        ...
        public readonly static String GetPatientData = "get patient data";
        public readonly static String GetPatientSesssions = "get patient sessions";
        
        public readonly static String SetResistance = "set resitance";
